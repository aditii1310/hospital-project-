...
<body>
    ...
    <section id="home" class="section">
        <div class="content">
            ...
            <p>Your health is our priority. Explore our services and book an appointment with ease.</p>
        </div>
    </section>
    ...
    <section id="about" class="section">
        <div class="content">
            <h2>About Us</h2>
            <p>We are a multi-specialty hospital providing top-notch healthcare services with modern facilities and a compassionate team of experts.</p>
        </div>
    </section>
