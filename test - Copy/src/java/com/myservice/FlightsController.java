...
import com.myservice.util.JsfUtil;
import com.myservice.util.PaginationHelper;
...
public class FlightsController implements Serializable {
    ...
    @EJB
    private com.myservice.FlightsFacade ejbFacade;
    ...
    public Flights getFlights(java.lang.Integer id) {
