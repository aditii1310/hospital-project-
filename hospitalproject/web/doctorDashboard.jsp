...
<body>
    ...
    <section id="home">
        ...
        <p>"Manage your patients and appointments efficiently" means that the system provides a streamlined and organized way to handle patient records and schedule appointments. </p>
    </section>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" action="updatePatientS.jsp">
